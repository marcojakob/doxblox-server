...
(function () {
    ...
    as.config(function ($routeProvider, $httpProvider) {
        ...
        $routeProvider.when('/person', { controller: 'PersonController', templateUrl: 'angular/person.html'});
        $routeProvider.when('/admin', { controller: 'AdminController', templateUrl: 'angular/admin/admin.html'});
